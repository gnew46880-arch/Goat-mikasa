...
module.exports.onStart = async ({
    ...
    try {
        ...
        if (args[0] === 'edit') {
            ...
            const dA = (await axios.get(`${link}?edit=${encodeURIComponent(editKey)}&oldReply=${encodeURIComponent(oldReply)}&replace=${encodeURIComponent(newReply)}&senderID=${uid}&font=1`)).data.message;
